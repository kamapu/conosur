...
#' Get Synonyms for conosur_species Output.
#' 
...
#' @param Home Character value indicating the database address.
#' @param progress Logical value indicating whether a progress bar should be
#' displayed (the default) or not.
#' @return A list containing synonyms in data frames, each data frame
#' corresponding to a species in \code{'x'}.
